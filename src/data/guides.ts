...
`,
  },
  {
    ...
    title: 'How Many Wins to Rank Up in CS2? (2026 Guide)',
    titleZh: 'CS2 升一段要赢几场(2026)',
    description: 'There is no fixed CS2 win count for ranking up. See practical Premier and Competitive ranges, what changes rating gains, and when to stop queueing.',
