...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/play/routines/rifle-entry`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${BASE_URL}/play/routines/awp-flick`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${BASE_URL}/play/routines/spray-transfer`, lastModified, changeFrequency: 'weekly', priority: 0.85 },
    ...
    { url: `${BASE_URL}/crosshairs/dot`, lastModified, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/crosshairs/pro`, lastModified, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/tools/crosshair-generator`, lastModified, changeFrequency: 'monthly', priority: 0.8 },
